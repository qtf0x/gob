...
#define define_poro_1()                                                                                                                                                           \
	({                                                                                                                                                                        \
		/* n = (V_v - VSI) /V_t where n is porosity (%), V_v is volume of voids (cubic meters),  vsi is volumetric strain (%), and V_t is total volume (cubic meters). */ \

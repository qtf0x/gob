	...
	(let ((dialog-box #f)
		...
		(define (apply-cb . args)
            ; Set variables based on button selection
			      (rpsetvar 'longwallgobs/field_velocity_button (cx-show-toggle_button longwallgobs/field_velocity_button))
            (rpsetvar 'longwallgobs/blackbody_button (cx-show-toggle_button longwallgobs/blackbody_button))
            (rpsetvar 'longwallgobs/blackbody_extended_button (cx-show-toggle_button longwallgobs/blackbody_extended_button))
            (rpsetvar 'longwallgobs/cividis_button (cx-show-toggle_button longwallgobs/cividis_button))
            (rpsetvar 'longwallgobs/coolwarm_bent_button (cx-show-toggle_button longwallgobs/coolwarm_bent_button))
            (rpsetvar 'longwallgobs/coolwarm_smooth_button (cx-show-toggle_button longwallgobs/coolwarm_smooth_button))
            (rpsetvar 'longwallgobs/inferno_button (cx-show-toggle_button longwallgobs/inferno_button))
            (rpsetvar 'longwallgobs/kindlmann_button (cx-show-toggle_button longwallgobs/kindlmann_button))
            (rpsetvar 'longwallgobs/kindlmann_extended_button (cx-show-toggle_button longwallgobs/kindlmann_extended_button))
            (rpsetvar 'longwallgobs/magma_button (cx-show-toggle_button longwallgobs/magma_button))
			      (rpsetvar 'longwallgobs/plasma_button (cx-show-toggle_button longwallgobs/plasma_button))
            (rpsetvar 'longwallgobs/viridis_button (cx-show-toggle_button longwallgobs/viridis_button))
		...
		(lambda args
          ...
          ; Box to put radio buttons in
					(set! longwallgobs/colormap_button_box (cx-create_button-box table "Colormap" 'radio-mode #t 'col 0))
          ; Radio buttons for the table
					(set! longwallgobs/field_velocity_button (cx-create-toggle_button longwallgobs/colormap_button_box "Field Velocity (Default)"))
					(set! longwallgobs/blackbody_button (cx-create-toggle_button longwallgobs/colormap_button_box "Black Body"))
					(set! longwallgobs/blackbody_extended_button (cx-create-toggle_button longwallgobs/colormap_button_box "Extended Black Body"))
					(set! longwallgobs/cividis_button (cx-create-toggle_button longwallgobs/colormap_button_box "Cividis"))
					(set! longwallgobs/coolwarm_bent_button (cx-create-toggle_button longwallgobs/colormap_button_box "Smooth Cool Warm"))
					(set! longwallgobs/coolwarm_smooth_button (cx-create-toggle_button longwallgobs/colormap_button_box "Bent Cool Warm"))
					(set! longwallgobs/inferno_button (cx-create-toggle_button longwallgobs/colormap_button_box "Inferno"))
					(set! longwallgobs/kindlmann_button (cx-create-toggle_button longwallgobs/colormap_button_box "Kindlmann"))
					(set! longwallgobs/kindlmann_extended_button (cx-create-toggle_button longwallgobs/colormap_button_box "Extended Kindlmann"))
					(set! longwallgobs/magma_button (cx-create-toggle_button longwallgobs/colormap_button_box "Magma"))
					(set! longwallgobs/plasma_button (cx-create-toggle_button longwallgobs/colormap_button_box "Plasma"))
					(set! longwallgobs/viridis_button (cx-create-toggle_button longwallgobs/colormap_button_box "Viridis"))

      ...
      ; (if (equal? (rpgetvar 'longwallgobs/<button name>) #t) (ti-menu-load-string "file/read-colormap colormaps/<file name>\n")) ; NEW COLORMAP
		...
		(lambda args
          ...
          (set! longwallgobs/explosive_plots_button (cx-create-toggle-button longwallgobs/colormap_button_box "Explosive Plots"))
					...
					(set! longwallgobs/coolwarm_bent_button (cx-create-toggle-button longwallgobs/colormap_button_box "Bent Cool Warm"))
					(set! longwallgobs/coolwarm_smooth_button (cx-create-toggle-button longwallgobs/colormap_button_box "Smooth Cool Warm"))
